...
% \setsansfont[Scale=1.09]{Segoe UI} % Windows
% \setCJKsansfont{Meiryo}            % Windows
% \setmonofont{Consolas Bold}        % Windows
\setsansfont{Noto Sans}            % Linux (Ubuntu, Opensuse, etc...)
\setCJKsansfont{Noto Sans JP}      % Linux
\setmonofont{Ubuntu Mono Bold}     % Linux
\setmathfont[Scale=1.09, FakeBold=1.0]{latinmodern-math.otf}
\setmathrm[Scale=1.09, FakeBold=1.0]{latinmodern-math.otf}
\setmathfont[Scale=1.13, FakeBold=0.8, range={bb}]{XITS Math}
\setmathfont[Scale=1.09, FakeBold=1.0,range={cal}]{STIX Two Math}
